        ...
        .then((res) => {
          ...
          if (this.activeName === "first") {
            ...
            if (flag) {
              ...
              //  console.log('cameraId',this.$store.state.deleteCameraId._id,this.$store.state.deleteCameraId);
              // this.getDevicesList();
            }
          }
        })
      ...
      deviceApi
        ...
        .then((res) => {
          ...
          if (res.code===0){
            ...
            this.$bus.$emit('resetAllDevices',this.allPoints,this.allMessage)
