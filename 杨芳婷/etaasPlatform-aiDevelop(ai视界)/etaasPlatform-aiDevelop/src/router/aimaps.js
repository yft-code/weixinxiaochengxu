...
const paasMaps = [
  {
    path: "/",
    name: "login",
    component: resolve => require(["@/views/ai/login/index"], resolve)
  },
  {
    path: "deviceManage",
    name: "deviceManage",
    meta: { title: "设备管理", icon: "icon-a-EquipmentManagement" },
    component: resolve =>
      require(["@/views/ai/deviceManage/index"], resolve)
  },
  {
    path: "/3D",
    name: "3D",
    meta: { title: "3D实景仿真", icon: "icon-a-3D_line" },
    component: resolve => require(["@/views/ai/3dIndex/index"], resolve),
  },
  {
    path: "earlyWarning",
    name: "earlyWarning",
  ...
  },
  {
    path: "/algorithm",
    name: "algorithm",
    meta: { title: "算法管理", icon: "icon-suanfa" },
    component: resolve => require(["@/views/ai/aiIndex/index"], resolve),
    children: [
      {
        path: "algorithmManage",
        name: "algorithmManage",
        meta: { title: "算法库", icon: "icon-a-AlgorithmManagement" },
        component: resolve =>
          require(["@/views/ai/algorithmManage/index"], resolve)
      }
    ],
  },
  {
